disease_dic = {
    'Apple___Apple_scab': """ <b>Crop</b>: Apple <br/>Growth: Apple Scab<br/>
        <br/> Cause of disease:

        <br/><br/> 1. Apple scab overwinters primarily in fallen leaves and in the soil. Growth development is favored by wet, cool weather that generally occurs in spring and early summer.
    ...
    'Apple___Black_rot': """ <b>Crop</b>: Apple <br/>Growth: Black Rot<br/>
        <br/> Cause of disease:
    ...
    'Apple___Cedar_apple_rust': """ <b>Crop</b>: Apple <br/>Growth: Cedar Apple Rust<br/>
        <br/> Cause of disease:
    ...
    'Apple___healthy': """ <b>Crop</b>: Apple <br/>Growth: No disease<br/>
    ...
    'Blueberry___healthy': """ <b>Crop</b>: Blueberry <br/>Growth: No disease<br/>
    ...
    'Cherry_(including_sour)___Powdery_mildew': """ <b>Crop</b>: Cherry <br/>Growth: Powdery Mildew<br/>
        <br/> Cause of disease:
    ...
    'Cherry_(including_sour)___healthy': """ <b>Crop</b>: Cherry <br/>Growth: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",


    'Corn_(maize)___Cercospora_leaf_spot Gray_leaf_spot': """ <b>Crop</b>: Corn <br/>Growth: Grey Leaf Spot<br/>
        <br/> Cause of disease:
    ...
    'Corn_(maize)___Common_rust_': """ <b>Crop</b>: Corn(maize) <br/>Growth: Common Rust<br/>
        <br/> Cause of disease:
    ...
    'Corn_(maize)___Northern_Leaf_Blight': """ <b>Crop</b>: Corn(maize) <br/>Growth: Northern Leaf Blight
        <br/>
        <br/> Cause of disease:
    ...
    'Grape___Black_rot': """ <b>Crop</b>: Grape <br/>Growth: Black Rot<br/>
        <br/> Cause of disease:
    ...
    'Corn_(maize)___healthy': """ <b>Crop</b>: Corn(maize) <br/>Growth: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",


    'Grape___Esca_(Black_Measles)': """ <b>Crop</b>: Grape <br/>Growth: Black Measles<br/>
        <br/> Cause of disease:
    ...
    'Grape___Leaf_blight_(Isariopsis_Leaf_Spot)': """ <b>Crop</b>: Grape <br/>Growth: Leaf Blight<br/>
        <br/> Cause of disease:
    ...
    'Grape___healthy': """ <b>Crop</b>: Grape <br/>Growth: No disease<br/>
    ...
    'Grape___Leaf_blight_(Isariopsis_Leaf_Spot)': """<b> Crop</b> : Grape <br/> Growth: Leaf Spot""",


    'Orange___Haunglongbing_(Citrus_greening)': """ <b>Crop</b>: Orange <br/>Growth: Citrus Greening<br/>
        <br/> Cause of disease:
    ...
    'Peach___Bacterial_spot': """ <b>Crop</b>: Peach <br/>Growth: Bacterial Spot<br/>
        <br/> Cause of disease:
    ...
    'Pepper,_bell___Bacterial_spot': """ <b>Crop</b>: Pepper <br/>Growth: Bacterial Spot<br/>
        <br/> Cause of disease:
    ...
    'Peach___healthy': """ <b>Crop</b>: Peach <br/>Growth: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    'Pepper,_bell___healthy': """ <b>Crop</b>: Pepper <br/>Growth: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",


    'Potato___healthy': """ <b>Crop</b>: Potato <br/>Growth: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    'Raspberry___healthy': """ <b>Crop</b>: Raspberry <br/>Growth: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",


    'Soybean___healthy': """ <b>Crop</b>: Soyabean <br/>Growth: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    'Strawberry___healthy': """ <b>Crop</b>: Strawberry <br/>Growth: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    'Tomato___healthy': """ <b>Crop</b>: Tomato <br/>Growth: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",


    'Potato___Early_blight': """ <b>Crop</b>: Potato <br/>Growth: Early Blight<br/>
        <br/> Cause of disease:
    ...
    'Potato___Late_blight': """ <b>Crop</b>: Potato <br/>Growth: Late Blight<br/>
    ...
    'Squash___Powdery_mildew': """ <b>Crop</b>: Squash <br/>Growth: Powdery mildew<br/>
        <br/> Cause of disease:
    ...
    'Strawberry___Leaf_scorch': """ <b>Crop</b>: Strawberry <br/>Growth: Leaf Scorch<br/>
        <br/> Cause of disease:
    ...
    'Tomato___Bacterial_spot': """ <b>Crop</b>: Tomato <br/>Growth: Bacterial Spot<br/>
        <br/> Cause of disease:
    ...
    'Tomato___Early_blight': """ <b>Crop</b>: Tomato <br/>Growth: Early Blight<br/>
        <br/> Cause of disease:
    ...
    'Tomato___Late_blight': """ <b>Crop</b>: Tomato <br/>Growth: Late Blight<br/>
    ...
    'Tomato___Leaf_Mold': """ <b>Crop</b>: Tomato <br/>Growth: Leaf Mold<br/>
        <br/> Cause of disease:
    ...
    'Tomato___Septoria_leaf_spot': """ <b>Crop</b>: Tomato <br/>Growth: Leaf Spot<br/>
        <br/> Cause of disease:
    ...
    'Tomato___Spider_mites Two-spotted_spider_mite': """ <b>Crop</b>: Tomato <br/>Growth: Two-spotted spider mite<br/>
        <br/> Cause of disease:
    ...
    'Tomato___Target_Spo': """ <b>Crop</b>: Tomato <br/>Growth: Target Spot<br/>
        <br/> Cause of disease:
    ...
    'Tomato___Tomato_Yellow_Leaf_Curl_Virus': """ <b>Crop</b>: Tomato <br/>Growth: Yellow Leaf Curl Virus<br/>
        <br/> Cause of disease:
    ...
    'Tomato___Tomato_mosaic_virus': """ <b>Crop</b>: Tomato <br/>Growth: Mosaic Virus<br/>
        <br/> Cause of disease:
